...
const Resume12 = forwardRef((props, ref) => {
  ...
  const componentLeft = {
    Language: (
      <Language
        ...
        BgColor={color}
        bgText={true}
        StyleTitle={`${textLg} text-white text-center font-semibold`}
  ...
  const componentRight = {
    ...
    Education: (
      <Education
        ...
        border={true}
        colorTitle={"white"}
        StyleTitle={`${textLg} px-5 font-semibold w-auto text-center `}
        Icon={false}
        IconColor={color}
    ...
    Employment: (
      <Employment
        ...
        border={true}
        colorTitle={"white"}
        StyleTitle={`px-5 ${textLg} font-semibold w-auto text-center`}
        Icon={false}
        IconColor={color}
        styleContainerList={"border-l-4 pl-4 mb-2"}
        styleList={"flex flex-row justify-between items-center"}
      ...
      <div className=" ms-9 border-0">
        ...
        <div className="h-auto px-4">
          <Profile
            ...
            bgText={true}
            colorText={"white"}
            styleContainerTitle={`${textLg} text-center font-semibold`}
            Color={color}

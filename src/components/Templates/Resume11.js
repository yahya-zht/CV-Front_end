...
let c = 0;
const Resume11 = forwardRef((props, ref) => {
  ...
  const [primaryColor, setPrimaryColor] = useState("#B39EA0"); //Primary primaryColor
  const [secondaryColor, setSecondaryColor] = useState("#DCD1D0"); //Secondary primaryColor
  ...
  const componentRight = {
    Education: (
      <Education
        ...
        StyleTitle={`${textLg} px-2 font-semibold w-auto text-white text-center`}
        Icon={false}
    ...
    Employment: (
      <Employment
        ...
        BgColor={primaryColor}
        border={false}
        StyleTitle={` px-2 ${textLg} font-semibold w-auto text-white text-center`}
        Icon={false}
        IconColor={primaryColor}
        styleContainerList={"pl-4 mb-2"}
        styleList={"flex flex-row justify-between items-center"}
  ...
  return (
    <div className="flex flex-row bg-white h-full relative">
      <PersonalInfo
        BgColor={c == 0 ? secondaryColor : primaryColor}
